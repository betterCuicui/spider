...
<TITLE>登录页面</TITLE>
<SCRIPT src="__PUBLIC__/jsindex/jquery-1.9.1.min.js" type="text/javascript"></SCRIPT>
...
.u_logo {
	background: url("__PUBLIC__/imageindex/username.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 43px;
	left: 40px;
...
.p_logo {
	background: url("__PUBLIC__/imageindex/password.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 12px;
	left: 40px;
...
.tou {
	background: url("__PUBLIC__/imageindex/tou.png") no-repeat;
	width: 97px;
	height: 92px;
	position: absolute;
	top: -87px;
...
.left_hand {
	background: url("__PUBLIC__/imageindex/left_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.right_hand {
	background: url("__PUBLIC__/imageindex/right_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.initial_left_hand {
	background: url("imageindex/hand.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -12px;
...
.initial_right_hand {
	background: url("__PUBLIC__/imageindex/hand.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -12px;
...
.left_handing {
	background: url("imageindex/left-handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -24px;
...
.right_handinging {
	background: url("__PUBLIC__/imageindex/right_handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -21px;
